...
<p>-It is assumed that a would-be attacker has applied social engineering techniques to cause a user to open the remote executable, allowing for reverse shell execution.</p>
